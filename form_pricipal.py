...
class FormPrincipal:
    def __init__(self):
        ...
        self.lblPrompt=tk.Label(self.root,
        text="Bienvenu à l'application gestion des clients",
        bg="Blue",
        fg="White",
        ...
        command=self.root.destroy,bd=10,bg="Red")
        self.btnQuitter.pack(side="bottom")

        self.frameButton=tk.Frame(self.root) 
        self.frameButton.pack(expand='YES') 

        self.btnGestionProduit=tk.Button(self.frameButton,text="Gestion des Produits",
        bd=10,bg="Blue",fg="White",font="Arial 16 italic bold",
        command=self.openFormGestionProduit)

        self.btnGestionProduit.pack(side="left")

        self.btnGestionHabit=tk.Button(self.frameButton,text="Gestion des Habits",
        bd=10,bg="Blue",fg="White",font="Arial 16 italic bold",
        command=self.openFormGestionHabit)

        self.btnGestionHabit.pack(side="left")

        self.btnGestionProduitE=tk.Button(self.frameButton,text="Gestion Produit Elect.",
        bd=10,bg="Blue",fg="White",font="Arial 16 italic bold")
